...
data_selection <- data |> 
  ...
  group_by(PupBirthyear, fitness_class, pup_SNPed) |> 
  ...
  ungroup() |> 
  arrange(PupBirthyear, fitness_class, pup_SNPed) |> 
  group_by(PupBirthyear, fitness_class) |> 
