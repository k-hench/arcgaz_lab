...
ggsave(filename = "img/genomes_n50.svg",
       plot = p0,
       height = 12,
       width = 6)
...
ggsave(filename = "img/genomes_length.svg",
       plot = p1,
       height = 12,
       width = 6)
...
ggsave(filename = "img/genomes_sorted.svg",
       plot = p3,
       height = 12,
       width = 6)

write_tsv(data,
          file = "results/genome_stats.tsv")